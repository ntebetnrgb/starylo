...
CREATE TABLE "Spot" (
    ...
    "emoji" TEXT,
    "category" TEXT,
    CONSTRAINT "Spot_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Trip" (
    ...
    CONSTRAINT "Trip_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "TripStyle" (
    ...
    PRIMARY KEY ("tripId", "travelStyleId"),
    CONSTRAINT "TripStyle_tripId_fkey" FOREIGN KEY ("tripId") REFERENCES "Trip" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "TripStyle_travelStyleId_fkey" FOREIGN KEY ("travelStyleId") REFERENCES "TravelStyle" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Guide" (
    ...
    CONSTRAINT "Guide_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Booking" (
    ...
    CONSTRAINT "Booking_guideId_fkey" FOREIGN KEY ("guideId") REFERENCES "Guide" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
